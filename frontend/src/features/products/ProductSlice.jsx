...
export const removeProductByIdAsync = createAsyncThunk(
  "products/removeProductByIdAsync",
  async (id) => {
    const removedProduct = await removeProductById(id);
...
const productSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(removeProductByIdAsync.pending, (state) => {
        state.status = "pending";
      })
      .addCase(removeProductByIdAsync.fulfilled, (state, action) => {
        state.status = "fullfilled";
        state.products = state.products.filter(
          (product) => product._id !== action.payload._id
        );
      })
      .addCase(removeProductByIdAsync.rejected, (state, action) => {
        state.status = "rejected";
        state.errors = action.error;
      });
  },
