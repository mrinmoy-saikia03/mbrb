...
import { IndianRupee, Link2, MoveUpRight, Package2 } from "lucide-react";
import {
  Card,
  CardHeader,
  CardBody,
...
export function OrderCard({ order }) {
  ...
  return (
    <Card className="w-full">
      <CardHeader
        color="blue-gray"
        className="relative h-16 flex items-center px-6 mt-4"
      >
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <Typography
                    ...
                    className="font-normal"
                  >
                    Weight: {item.selectedWeightOption.weight} × {item.quantity}
                  </Typography>
                  <Typography
                    variant="small"
                    color="gray"
            ...
            {order.address[0] && (
              <div className="space-y-2">
                ...
                <Typography
                  ...
                  className="font-normal"
                >
                  City: {order.address[0].city}, State: {order.address[0].state}
                </Typography>
                <Typography
                  variant="small"
                  color="gray"
