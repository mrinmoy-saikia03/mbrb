  ...
  try {
    ...
    if (
      ...
      res.cookie("token", token, {
        sameSite: process.env.PRODUCTION === "true" ? "None" : "Lax",
        maxAge:
          parseInt(process.env.COOKIE_EXPIRATION_DAYS) * 24 * 60 * 60 * 1000, // Corrected maxAge
        httpOnly: true,
        secure: process.env.PRODUCTION === "true", // Ensure secure flag is properly set
    ...
    // Clear cookie if authentication fails
